          ...
          <div className="contact-layout">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <textarea
                  name="message"
                  placeholder="Please describe your project, the type of support you need, and your timeline. The more detail you provide, the more useful our initial response will be."
                  required
                />
              </div>
              <button
